...
import com.liferay.docs.tasks.model.FooModel;
import com.liferay.docs.tasks.model.FooSoap;
...
public class FooModelImpl extends BaseModelImpl<Foo> implements FooModel {
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.docs.tasks.service.util.ServiceProps.get(
				"value.object.entity.cache.enabled.com.liferay.docs.tasks.model.Foo"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.docs.tasks.service.util.ServiceProps.get(
				"value.object.finder.cache.enabled.com.liferay.docs.tasks.model.Foo"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.docs.tasks.service.util.ServiceProps.get(
				"value.object.column.bitmask.enabled.com.liferay.docs.tasks.model.Foo"),
			true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.docs.tasks.service.util.ServiceProps.get(
				"lock.expiration.time.com.liferay.docs.tasks.model.Foo"));
	...
	public String toXmlString() {
		...
		sb.append("com.liferay.docs.tasks.model.Foo");
